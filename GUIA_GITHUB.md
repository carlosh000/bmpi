...
## Método rápido (script incluido)

Puedes usar el script que ya dejé en el repo:

```bash
scripts/publicar_github.sh https://github.com/TU_USUARIO/TU_REPO.git work
```

Este script:
- configura/actualiza `origin`,
- cambia a la rama indicada si hace falta,
- y ejecuta `git push -u origin <rama>`.
